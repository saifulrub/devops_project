package ai.insyght.hireng.repository;

import ai.insyght.hireng.JhipsterApp;

import ai.insyght.hireng.config.Constants;
import ai.insyght.hireng.config.audit.AuditEventConverter;
import ai.insyght.hireng.domain.PersistentAuditEvent;
...
import static ai.insyght.hireng.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
